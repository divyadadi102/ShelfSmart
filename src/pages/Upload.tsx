...
const Upload = () => {
  ...
  const handleSubmitFile = async () => {
    ...
    try {
      ...
      // localhost URL: http://127.0.0.1:8000/api/upload
      ...
      toast({
        ...
        description: `Your data has been processed. Rows inserted: ${data.rows_inserted}. All predictions (today, tomorrow, next week) have been generated.`,
      });
      setUploading(false);
      navigate("/dashboard");
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Date, Item Nbr, Item Name, Category, Item Class(Sub Category), Unit Sales, On Promotion, Holiday, Perishable, Cost Price, Price.
                            </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">YYYY-MM-DD</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Maximum 2MB</p>
                        </div>
                      </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-3 bg-gray-50 rounded-lg text-center">
                          <p className="font-medium">Revel Systems</p>
                          <p className="text-sm text-gray-600">Coming Soon</p>
                        </div>
                      </div>
